...
void DemoGame::init(Engine &engine) {
    ...
    const auto metallicMap = engine.loadMetallicMap(std::format("textures/{}_metallic.png", selectedTexture));
    ...
    constexpr float INNER_RADIUS = 30.0f;
    constexpr float OUTER_RADIUS = 35.0f;
