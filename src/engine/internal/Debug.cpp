...
constexpr std::array cpuPassNames = {"poll",   "camera update", "fence wait", "acquire",  "buffer update",
                                     "record", "submit",        "present",    "CPU total"};

constexpr std::array gpuPassNames = {"frame setup", "HiZ build", "culling", "opaque", "xray", "text", "GPU total"};
